...
def draw_sun(screen):
    pygame.draw.circle(screen,YELLOW,[200,200],80, 80)
    pygame.draw.line(screen,YELLOW,[50,100],[200,150], 2)
    pygame.draw.line(screen,YELLOW,[50,100],[200,190], 2)
    pygame.draw.line(screen,YELLOW,[150,40],[150,150], 2)
